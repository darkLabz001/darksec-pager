// Copy this file to src/private_config.h for local builds.
// Do not commit src/private_config.h. It is ignored by .gitignore.

#pragma once

#define DEFAULT_SSID "YourHotspot"
#define DEFAULT_PASS "YourWiFiPassword"
#define DEFAULT_SSID2 "YourHomeNetwork"
